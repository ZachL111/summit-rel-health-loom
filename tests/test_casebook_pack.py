"""Regression checks for the summit-rel-health-loom casebook."""
...
from casebook.harness import assert_expected, summit_rel_health_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(summit_rel_health_loom_summary(), assert_expected())
